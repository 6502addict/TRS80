...
-- Date    : 2026-04-25
-- Author  : didier
-- Changes : 1.1 - upgraded to 3 scanlines for full screen display
--           1.0 - Initial version
-- =============================================================================
...
architecture behavior OF trs80_ctrl IS
begin
    process (reset_n, clock)
        ...
        variable sline      : integer range 0 to 13;              -- scanline within current char cell
        ...
        constant char_h_text : integer := 11;  -- was 8
        ...
        constant tmargin   : integer := svdisp + 12; -- 92; -- was 108
        constant bmargin   : integer := evdisp - 12; -- 92; -- was 108
    ...
    BEGIN
        if (reset_n = '0') then
            ...
            --    if (sline = char_h_text) or (vpos < tmargin) or (vpos >= bmargin) then
                if (vpos < tmargin) or (vpos >= bmargin) then
                    blank <= '1';
                else
                    blank <= '0';
                end if;
