-- =============================================================================
-- File    : prog_clock_divider.vhd
-- Version : 1.1
-- Date    : 2026-04-25
-- Author  : didier
-- Changes : 1.1 - Fixed asymmetric clock output (div registered signal replaced
--                 by combinatorial output from cnt)
--           1.0 - Initial version
-- =============================================================================
...
begin
    ...
    clk_out <= clk_in when unsigned(divider) < 2 else
               '1' when cnt >= hdiv else '0'; 
